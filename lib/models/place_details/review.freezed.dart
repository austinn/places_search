...
class _$ReviewImpl implements _Review {
  ...
  @override
  String toString() {
    return 'Review(authorName: $authorName, rating: $rating, relativeTimeDescription: $relativeTimeDescription, time: $time, authorUrl: $authorUrl, language: $language, originalLanguage: $originalLanguage, profilePhotoUrl: $profilePhotoUrl, text: $text, translated: $translated)';
  }
